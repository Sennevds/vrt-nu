namespace StevenVolckaert.VrtNu.Core.Tests
{
    ...
    {
        [Fact]
        public async Task GetAllProgramCategoriesAsyncTest()
        {
            IVrtNuDataService service = new VrtNuDataService();

            var programCategories = await service.GetAllProgramCategoriesAsync();
            var programCategoriesList = programCategories.ToList();

            Assert.NotEmpty(programCategoriesList);
        }

        [Fact]
        public async Task GetAllProgramsAsyncText()
        {
            IVrtNuDataService service = new VrtNuDataService();
        ...
        public async Task GetLiveChannelsAsyncTest(int expectedPosition, string expectedChannelName, string expectedUrl)
        {
            IVrtNuDataService service = new VrtNuDataService();
